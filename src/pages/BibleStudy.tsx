...
const BibleStudy = () => {
  ...
  const [autoReferences, setAutoReferences] = useState<
    Array<{ reference: string; verse: string; context: string }>
  >([]);
  const [aiQuestion, setAiQuestion] = useState('');
  const [aiResponse, setAiResponse] = useState('');
  const [textAnalysisMode, setTextAnalysisMode] = useState<
    'verse' | 'theme' | 'custom'
  >('verse');
  ...
  const bibleThemes = [
    {
      id: 1,
      name: 'Amor de Deus',
      description: 'Versículos sobre o amor incondicional de Deus',
      verseCount: 156,
    },
    {
      id: 2,
      name: 'Fé e Confiança',
      description: 'Ensinamentos sobre ter fé em Deus',
      verseCount: 243,
    },
    {
      id: 3,
      name: 'Perdão',
      description: 'Versículos sobre perdão divino e humano',
      verseCount: 89,
    },
    {
      id: 4,
      name: 'Esperança',
      description: 'Mensagens de esperança e promessas',
      verseCount: 134,
    },
    {
      id: 5,
    ...
    },
    {
      id: 6,
      name: 'Oração',
      description: 'Ensinamentos sobre a vida de oração',
      verseCount: 167,
    },
    {
      id: 7,
      name: 'Sabedoria',
      description: 'Provérbios e ensinamentos sobre sabedoria',
      verseCount: 201,
    },
    {
      id: 8,
      name: 'Família',
      description: 'Orientações para a vida familiar cristã',
      verseCount: 78,
    },
    {
      id: 9,
      name: 'Obediência',
      description: 'Versículos sobre obediência a Deus',
      verseCount: 112,
    },
    {
      id: 10,
      name: 'Prosperidade',
      description: 'Bênçãos e prosperidade segundo Deus',
      verseCount: 95,
    },
  ];

  const currentBookData = Object.values(bibleBooks)
    .flat()
  ...
  const verses = [
    {
      ...
      crossReferences: [
        ...
        },
        {
          ...
          text: 'Pela fé, entendemos que foi o universo formado...',
        },
        {
      ...
      comments: [
        {
          id: 1,
          author: 'João Silva',
          text: 'Este versículo estabelece a base de toda nossa fé.',
          date: '2024-01-15',
        },
        {
          id: 2,
          author: 'Maria Santos',
          text: "A palavra 'princípio' aqui é fundamental para entender...",
          date: '2024-01-10',
        },
      ],
      favorites: 1243,
    ...
    },
    {
      ...
      crossReferences: [
        {
          reference: 'Jeremias 4:23',
          text: 'Olhei para a terra, e eis que estava sem forma e vazia...',
        },
        {
          reference: 'Isaías 45:18',
          text: 'Porque assim diz o Senhor que criou os céus...',
        },
      ],
      themes: [1, 7],
      comments: [
        {
          id: 3,
          author: 'Pedro Costa',
          text: 'O Espírito de Deus já estava presente desde o início.',
          date: '2024-01-12',
        },
      ],
      favorites: 789,
    ...
    },
    {
      ...
      crossReferences: [
        {
          reference: '2 Coríntios 4:6',
          text: 'Porque Deus, que disse: Das trevas resplandecerá a luz...',
        },
        {
          reference: 'Salmos 33:9',
          text: 'Porque falou, e tudo se fez; mandou, e logo tudo apareceu.',
        },
        {
          reference: 'João 1:5',
      ...
      comments: [
        {
          id: 4,
          author: 'Ana Oliveira',
          text: 'O poder da palavra de Deus é absoluto e criativo.',
          date: '2024-01-14',
        },
        {
          id: 5,
          author: 'Carlos Lima',
          text: 'A luz física aqui prefigura Cristo, a luz do mundo.',
          date: '2024-01-13',
        },
      ],
      favorites: 1567,
  ...
  const recommendedVerses = [
    ...
    },
    {
      ...
      text: 'E sabemos que todas as coisas contribuem...',
      theme: 'Esperança',
    },
    {
  ...
  const highlightVerse = (text: string) => {
    ...
    return words.map((word, index) => {
      ...
      return (
        <span
          key={index}
          className={`${isImportant ? 'cursor-pointer rounded px-0.5 font-medium transition-colors hover:bg-primary/10 hover:text-primary' : ''}`}
  ...
  const mockAIThemeAnalysis = {
    Criação: {
      ...
      significance:
        'A criação revela o poder soberano de Deus e Sua ordem estabelecida.',
  ...
  const mockAutoReferences = [
    {
      reference: 'João 1:1',
      verse: 'No princípio era o Verbo...',
      context: 'Paralelo teológico sobre o princípio',
    },
    {
      reference: 'Hebreus 11:3',
      verse: 'Pela fé entendemos...',
      context: 'Criação pela palavra divina',
    },
    {
      reference: 'Salmos 33:6',
      verse: 'Pela palavra do Senhor...',
      context: 'Poder criativo da palavra',
    },
  ];
  ...
  const analyzeTextWithAI = async (text: string, mode: string) => {
    ...
    switch (mode) {
      case 'verse':
        ...
        setAiAnalysis(
          'Análise concluída! Este versículo apresenta elementos teológicos fundamentais.'
        );
        break;
      case 'theme':
        setAiInsights([
        ...
        break;
      case 'custom': {
        const detectedRefs = text.toLowerCase().includes('criação')
          ? mockAutoReferences
          : [];
        setAutoReferences(detectedRefs);
        setAiAnalysis(
          'Texto analisado! Referências bíblicas foram detectadas automaticamente.'
        );
        break;
      }
    }
              ...
              <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
                ...
                <SheetContent side="left" className="w-80">
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      Acesso completo às ferramentas de estudo
                    </SheetDescription>
                  </SheetHeader>
                </SheetContent>
              </Sheet>
                      ...
                      >
                        ...
                        <SelectContent>
                          <ScrollArea className="h-48">
                            {Array.from(
                              { length: currentBookData?.chapters || 1 },
                              (_, i) => i + 1
                            ).map(chapter => (
                              <SelectItem
                                key={chapter}
                        ...
                        {bibleThemes
                          ...
                          .map(theme => (
                            <div
                              ...
                              onClick={() =>
                                setSelectedTheme(theme.id.toString())
                              }
                            >
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription className="mt-2">
                          {verses.length} versículos • Tempo de leitura: ~
                          {Math.ceil(verses.length * 0.3)} min
                        </CardDescription>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Button
                        ...
                        <Button
                          ...
                          size="sm"
                          disabled={
                            selectedChapter >= (currentBookData?.chapters || 1)
                          }
                        >
                        ...
                        <div
                          ...
                          className={`group relative rounded-xl p-6 transition-all duration-200 ${
                            selectedVerse === verse.number
                              ? 'border-2 border-primary/20 bg-primary/5 shadow-lg'
                        ...
                        >
                          <div className="flex space-x-4">
                            ...
                            <div className="flex-1 space-y-4">
                              <p className="cursor-pointer font-serif text-lg leading-relaxed">
                                    ...
                                    <div className="space-y-3">
                                      ...
                                      {verse.comments.length > 2 && (
                                        <Button
                                          ...
                                          className="w-full"
                                        >
                                          Ver todos os {verse.comments.length}{' '}
                                          comentários
                                        </Button>
                                      )}
                                    </div>
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                        <span>
                          {selectedChapter} de {currentBookData?.chapters}
                        </span>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Baseado em seus estudos anteriores
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        {recommendedVerses.map((verse, index) => (
                          <div
                            key={index}
                            className="cursor-pointer rounded-lg border p-4 hover:bg-muted/30"
                          >
                ...
                <div className="grid gap-6">
                  ...
                  <Card className="border-primary/20 bg-gradient-to-r from-primary/5 to-secondary/5">
                    <CardHeader>
                      <CardTitle className="flex items-center space-x-3">
                        ...
                        <div>
                          <span className="text-2xl">
                            Assistente de Estudo Bíblico IA
                          </span>
                      ...
                      <CardDescription className="text-base">
                        Explore as Escrituras com análises inteligentes, criação
                        de textos personalizados e detecção automática de
                  ...
                  <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Analise versículos, temas ou textos personalizados com
                          IA
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        ...
                        <div>
                          ...
                          <Select
                            value={textAnalysisMode}
                            onValueChange={(
                              value: 'verse' | 'theme' | 'custom'
                            ) => setTextAnalysisMode(value)}
                          >
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                        ...
                        {aiAnalysis && (
                          <div className="animate-fade-in space-y-4 rounded-lg border bg-muted/30 p-4">
                              ...
                              <div>
                                ...
                                <div className="space-y-2">
                                  {aiInsights.map((insight, index) => (
                                    <div
                                      key={index}
                                      className="rounded border border-primary/10 bg-background/50 p-3"
                                    >
                              ...
                              <div>
                                ...
                                <div className="space-y-2">
                                  {autoReferences.map((ref, index) => (
                                    <div
                                      key={index}
                                      className="rounded border border-secondary/20 bg-background/50 p-3"
                                    >
                                      <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                          <Badge
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Faça perguntas sobre teologia, interpretação e
                          contexto bíblico
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                          ...
                          <div className="animate-fade-in rounded-lg border border-primary/20 bg-primary/5 p-4">
                            <div className="flex items-start space-x-3">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="mt-3 flex items-center space-x-2 border-t border-primary/10 pt-3">
                                  <Button variant="ghost" size="sm">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Crie seus próprios textos com detecção automática de
                        referências bíblicas e sugestões inteligentes
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                                ...
                                <div className="mt-2 space-y-1">
                                  {autoReferences
                                    ...
                                    .map((ref, index) => (
                                      <div
                                        key={index}
                                        className="rounded border border-primary/10 bg-primary/5 p-2 text-xs"
                                      >
                                        <Badge
                                          variant="outline"
                                          className="mb-1 text-xs"
              ...
              <TabsContent value="themes" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Descubra versículos organizados por temas bíblicos
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
      ...
      <Dialog open={showStatistics} onOpenChange={setShowStatistics}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Análise detalhada do livro bíblico
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-4">
              <div>
                <h4 className="mb-2 font-semibold">Informações Gerais</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>Total de Versículos:</span>
                    <span className="font-medium">
                      {bookStatistics.totalVerses}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Total de Capítulos:</span>
                    <span className="font-medium">
                      {bookStatistics.totalChapters}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Média por Capítulo:</span>
                    <span className="font-medium">
                      {bookStatistics.averageVersesPerChapter}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Tempo de Leitura:</span>
                    <span className="font-medium">
                      {bookStatistics.readingTime}
                    </span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="mb-2 font-semibold">Temas Principais</h4>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <h4 className="mb-2 font-semibold">Versículos Populares</h4>
                <div className="flex flex-wrap gap-2">
        ...
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            <DialogTitle className="flex items-center space-x-2">
              ...
              <span>
                Comparar Versões - {currentBookData?.name} {selectedChapter}:1
              </span>
            </DialogTitle>
            <DialogDescription>
              Compare diferentes traduções bíblicas
            </DialogDescription>
          </DialogHeader>
