...
export const LazyIndex = createLazyComponent(() => import('../Index'), {
...
export const LazyBlog = createLazyComponent(() => import('../Blog'), {
  loadingMessage: 'Carregando blog...',
});

export const LazyBlogPost = createLazyComponent(() => import('../BlogPost'), {
